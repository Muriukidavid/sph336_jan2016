...
sc_trace(tf, out1, "input1_is_zero_input2_zero");
sc_trace(tf, out2, "input1_is_one_jnput2_zero");
sc_trace(tf, out3, "input1_is_zero_input2_one");
sc_trace(tf, out4, "input1_is_one_input2_one");
